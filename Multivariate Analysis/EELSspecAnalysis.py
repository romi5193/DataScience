...
#determine the number of components using Singular Value Decomposition algorithm
...
#separate mutually independent components from a mixture using Blind Source Separation algorithm
s_C.blind_source_separation(number_of_components=5)
